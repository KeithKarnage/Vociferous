...
root.MainLoop = {
     ...
     *   milliseconds.
     */
    setBegin: function(fun,app) {
        begin = fun.bind(app) || begin;
        return this;
    },
     ...
     */
    setUpdate: function(fun,app) {
        update = fun.bind(app) || update;
        return this;
    },
     ...
     */
    setDraw: function(fun,app) {
        draw = fun.bind(app) || draw;
        return this;
    },
     ...
     */
    setEnd: function(fun,app) {
        end = fun.bind(app) || end;
        return this;
    },
